...
import { useAdminAuth } from "@/lib/adminStore";
...
function AdminLayout() {
  const { isAuthed, ready, login, logout } = useAdminAuth();
      ...
      <div className="min-h-screen grid place-items-center bg-gradient-to-br from-violet-200/60 via-white to-pink-200/60 px-5 relative overflow-hidden">
        ...
        >
          ...
          <div className="space-y-3">
            <div>
              <label className="text-[11px] font-semibold text-gray-700">Username</label>
              <input
                value={form.u}
          ...
          <button className="w-full h-11 rounded-full text-sm font-bold text-white bg-gradient-to-r from-violet-600 via-fuchsia-600 to-pink-500 shadow-lg hover:opacity-95 transition">
            Sign in
          </button>
